...
function App() {
  return (
      ...
      <section className='bg-gray-800 w-400 relative h-[490px] flex'>
        <Slider/>
        <div className='bg-white w-400 absolute top-26   h-[107px]'> 
          <div className='border border-gray-500 w-400 h-[107px] absolute'>
          </div>
        </div>
        </section>
        <section className='bg-white w-400 mt-20 mx-auto h-[600px]'>
          <div className='w-1/5 mt-20 mx-auto'>
        <div className='bg-gray-800 h-48 w-48 rounded-full  hover:bg-lime-500'>
            <button className=' hover:text-secondary py-20 px-13 pl-11 font-bold text-secondary'>LET'S DO IT!</button>
          </div>
          </div>
          <div className='mt-20'>
             <h3 className='text-3xl ml-10 text-primary font-bold'>Use Our Mortage Calculator</h3>
             <p>To Estimate Your Monthly</p>
             <p>Mortage Payment</p>
          </div>
        </section>
